...
public class DeliveryServiceTests {
    ...
    public void createDeliveryShouldSucceed() {
        ...
        assertEquals("cash", delivery.getPaymentType());
        assertEquals(date, delivery.getDate());
        assertEquals(true, delivery.isDelivered());
        assertEquals(true, delivery.isPaid());
    }
}
